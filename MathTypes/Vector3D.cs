...
namespace Raytracer.MathTypes
{
    ...
    public struct Vector3D : ISerializable, ICloneable
	{
		...
		public static Vector3D Parse(string s)
		{
			...
			{
				throw new ArgumentException("Unsuccessful Match.");
			}
		}
		#endregion
		...
		{
			return new Vector3D(v._x + w._x, v._y + w._y, v._z + w._z);
		}
		/// <summary>
		...
		{
			return new Vector3D(v._x + s, v._y + s, v._z + s);
		}
		/// <summary>
		...
		{
			return new Vector3D(s - v._x, s - v._y, s - v._z);
		}
		/// <summary>
		...
		{
			return new Vector3D(u._x / v._x, u._y / v._y, u._z / v._z);
		}
		/// <summary>
		...
		{
			return new Vector3D(u._x * s, u._y * s, u._z * s);
		}
		/// <summary>
        ...
        public void RotateX(double amnt, ref Vector3D dest)
        {
        ...
        public void RotateY(double amnt, ref Vector3D dest)
        {
            double s = MathLib.mLibSin(amnt);
            double c = MathLib.mLibCos(amnt);
            double x = this._x;
        ...
        public void RotateZ(double amnt, ref Vector3D dest)
        {
            double s = MathLib.mLibSin(amnt);
            double c = MathLib.mLibCos(amnt);
            double x = this._x;
