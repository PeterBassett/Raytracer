...
namespace Raytracer.MathTypes
{
    ...
    public struct Vector3F : ISerializable, ICloneable
    {
        ...
        */
        ...
        {
            return ApproxEqual(v, u, (float)MathLib.Epsilon);
        }
        /// <summary>
        ...
        public void RotateX(float amnt, Vector3F dest)
        {
            float s = MathLib.mLibSin(amnt);
            float c = MathLib.mLibCos(amnt);
            float y = this.Y;
            float z = this.Z;
        ...
        public void RotateY(float amnt, Vector3F dest)
        {
            float s = MathLib.mLibSin(amnt);
            float c = MathLib.mLibCos(amnt);
            float x = this.X;
        ...
        public void RotateZ(float amnt, Vector3F dest)
        {
            float s = MathLib.mLibSin(amnt);
            float c = MathLib.mLibCos(amnt);
            float x = this.X;
