...
{
    abstract class TracingRendererBase : IRenderer
    {
        ...
        public TracingRendererBase(int spp)
        {
            _spp = spp;
        }
        ...
        protected void AssertDependancies()
        {
            if (Scene == null)
        ...
        public virtual Colour ComputeSample(Vector2 pixelCoordinates)
        {
            return Trace(Camera.GenerateRayForPixel(pixelCoordinates));
        }

        protected virtual Colour Trace(Ray ray)
        {
            double t;
        ...
        protected abstract Colour TraceRay(Ray ray, Colour contribution, double curRefractionIndex, long depth, Vector eyeDirection, out double intersectionDistance);
        
        protected Colour CalculateRefraction(
        ...
        protected double PolarizedReflection(
        ...
        protected virtual Colour Shade(Point hitPoint, Normal normal, Material material, Vector eyeDirection)
        {
        ...
        protected Vector CalculateReflectedRay(Vector dir, Normal normal)
        {
            dir = (-dir).Normalize();
        ...
        protected Vector CalculateRefractedRay(Vector dir, Vector normal, double n_Out, double n_In)
        {
