...
{
    class VerticalCubemapBackground : CubemapBackground
    {
        public VerticalCubemapBackground(string filename) : base(filename)
        {	        		        
        }
        ...
        protected override void GetFaceCoordinates(Vector r, Axis imax, out Face face, out double s, out double t)
        {
            face = Face.Front;
            s = 0;
            t = 0;
